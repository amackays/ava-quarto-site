...
[Duke SoP](media/duke_grad-sop_ams-v6.pdf) \| [UC-Berkeley Research Statement](media/ucberkeley_grad-sop_ams-v6.pdf) \| [UC-Berkeley Personal Statement](media/ucberkeley_grad-ph_ams.pdf)
...
[NSF GRFP Research Statement](media/ams_grfp_final_v8.pdf) \| [NSF GRFP Personal Statement](media/v2_personal_ams_grfp.pdf)
...
[Ava's CV](media/AMS_resume.pdf)

### Building a Website

If you're interested in starting a website, I really recommend hosting your site with GitHub and using Wowchemy/Netlify or Quarto for a quick and streamlined website template! Here's a good [tutorial](https://ucsb-meds.github.io/creating-quarto-websites/) that I used. GitHub website deployment is pretty easy with their walkthrough [guides](https://docs.github.com/en/pages/quickstart).
